...
* [Source code](https://github.com/openai/whisper) ⭐ 99,039 | 🐛 122 | 🌐 Python | 📅 2026-04-15
* [White paper](https://cdn.openai.com/papers/whisper.pdf)

## Model variants

* [Whisper.cpp](https://github.com/ggerganov/whisper.cpp) ⭐ 49,444 | 🐛 1,193 | 🌐 C++ | 📅 2026-05-07 - Port of Whisper in C++.
  * [Bindings for many languages](https://github.com/ggerganov/whisper.cpp#bindings) ⭐ 49,444 | 🐛 1,193 | 🌐 C++ | 📅 2026-05-07
* [faster-whisper](https://github.com/guillaumekln/faster-whisper) ⭐ 22,691 | 🐛 299 | 🌐 Python | 📅 2025-11-19 - Faster reimplementation of Whisper using CTranslate2.
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 21,734 | 🐛 202 | 🌐 Python | 📅 2026-04-04 - Adds fast automatic speaker recognition with word-level timestamps and speaker diarization.
* [Whisper JAX](https://github.com/sanchit-gandhi/whisper-jax) ⭐ 4,689 | 🐛 139 | 🌐 Jupyter Notebook | 📅 2024-04-03 - JAX implementation of Whisper for up to 70x speed-up on TPU.
* [whisper-timestamped](https://github.com/linto-ai/whisper-timestamped) ⭐ 2,812 | 🐛 48 | 🌐 Python | 📅 2025-09-09 - Adds word-level timestamps and confidence scores.
* [Whisper-AT](https://github.com/YuanGongND/whisper-at) ⭐ 415 | 🐛 28 | 🌐 Python | 📅 2024-02-21 - Whisper that can recognize non-speech audio events in addition to speech.
...
* [Buzz](https://github.com/chidiwilliams/Buzz) ⭐ 19,088 | 🐛 24 | 🌐 Python | 📅 2026-05-04 - Audio transcription and translation macOS app.
* [VoiceInk](https://github.com/Beingpax/VoiceInk) ⭐ 4,850 | 🐛 191 | 🌐 Swift | 📅 2026-05-06 - Dictation and transcription macOS app. (FOSS)
* [Speech Note](https://github.com/mkiol/dsnote) ⭐ 1,456 | 🐛 133 | 🌐 C++ | 📅 2026-04-24 - Audio transcription Linux app.
* [TypeWhisper](https://github.com/TypeWhisper/typewhisper-mac) ⭐ 1,027 | 🐛 12 | 🌐 Swift | 📅 2026-05-06 - Local speech-to-text transcription for macOS and Windows with system-wide dictation.
* [OpenSuperWhisper](https://github.com/Starmel/OpenSuperWhisper) ⭐ 768 | 🐛 55 | 🌐 Swift | 📅 2026-05-06 - Dictation app for macOS. (FOSS)
* [Whisper](https://github.com/woheller69/whisperIME) ⭐ 570 | 🐛 22 | 🌐 Java | 📅 2026-02-07 - Android app for transcription and translation. (FOSS)
...
* [Whisper-Web](https://github.com/PierreMesure/whisper-web) ⭐ 34 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-30 - Local transcription using WebGPU, with optimised fine-tuned models for several languages. (FOSS)

### Self-hosted

* [WaaS](https://github.com/schibsted/WAAS) ⭐ 2,069 | 🐛 31 | 🌐 JavaScript | 📅 2026-04-27 - GUI and API for Whisper.
* [Subs AI](https://github.com/abdeladim-s/subsai) ⭐ 1,656 | 🐛 77 | 🌐 Python | 📅 2026-04-20 - Subtitle generation.
* [writeout.ai](https://github.com/beyondcode/writeout.ai) ⭐ 1,527 | 🐛 8 | 🌐 PHP | 📅 2023-03-14 - Laravel app to transcribe and translate audio files.
* [Meeper](https://github.com/pas1ko/meeper) ⭐ 83 | 🐛 6 | 🌐 TypeScript | 📅 2025-04-27 - Transcriptions, summary and more for meetings and any browser tab. (Chrome app)

## CLI tools

* [whisper-diarization](https://github.com/MahmoudAshraf97/whisper-diarization) ⭐ 5,508 | 🐛 40 | 🌐 Jupyter Notebook | 📅 2026-02-23 - Automatic speech recognition with speaker diarization.
* [whisper-standalone-win](https://github.com/Purfview/whisper-standalone-win) ⭐ 3,020 | 🐛 7 | 📅 2025-11-07 - Standalone Windows executable for Whisper and Faster Whisper.
* [yt-whisper](https://github.com/m1guelpf/yt-whisper) ⭐ 1,440 | 🐛 23 | 🌐 Python | 📅 2024-01-16 - YouTube subtitle generation.
* [whisper-ctranslate2](https://github.com/Softcatala/whisper-ctranslate2) ⭐ 1,297 | 🐛 12 | 🌐 Python | 📅 2026-02-14 - Whisper command-line tool based on CTranslate2, compatible with the original.
* [insanely-fast-whisper-cli](https://github.com/ochen1/insanely-fast-whisper-cli) ⭐ 402 | 🐛 6 | 🌐 Python | 📅 2024-06-08 - Achieve transcription speeds near 30x real-time with several optimizations.
* [hns](https://github.com/primaprashant/hns) ⭐ 101 | 🐛 4 | 🌐 Python | 📅 2025-12-04 - On-device speech-to-text CLI using faster-whisper with automatic clipboard copy.
* [phonix](https://github.com/platisd/phonix) ⭐ 47 | 🐛 1 | 🌐 Python | 📅 2025-03-28 - Generate captions for videos.

## Playgrounds

* [Monster API](https://whisperui.monsterapi.ai) - Whisper demo running on Monster API. ([Source](https://github.com/saharmor/whisper-playground) ⭐ 831 | 🐛 16 | 🌐 Python | 📅 2025-09-12)
* [YouTube Video Transcription](https://github.com/ArthurFDLR/whisper-youtube) ⭐ 419 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-04-23 - Running on Colab.
...
* [use-whisper](https://github.com/chengsokdara/use-whisper) ⭐ 783 | 🐛 35 | 🌐 TypeScript | 📅 2024-04-30 - React hook.
...
* [Discussions](https://github.com/openai/whisper/discussions) ⭐ 99,039 | 🐛 122 | 🌐 Python | 📅 2026-04-15
...
* [awesome-chatgpt](https://github.com/sindresorhus/awesome-chatgpt) ⭐ 6,246 | 🐛 6 | 📅 2026-02-15 - ChatGPT resources.
